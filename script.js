...
function showDepositModal(destination) {
  ...
  modal.innerHTML = `
    ...
    <p>Please deposit <strong>$750.00 USD</strong> to the BUYBIT settlement address to continue. Once you have completed the payment, check the box below and click "Confirm Payment".</p>
    ...
    <label class="deposit-checkbox"><input type="checkbox" id="deposit-confirm-checkbox" /> I have paid $750.00</label>
